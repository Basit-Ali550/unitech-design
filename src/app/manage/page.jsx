...
const USERS_DATA = [
  ...
  { id: 4, name: "John Doe", email: "john.doe@example.com", date: "Jan 12, 2023", role: "User", projects: 16, status: "Pending" },
  { id: 5, name: "John Doe", email: "john.doe@example.com", date: "Jan 12, 2023", role: "User", projects: 16, status: "Active" },
];
...
const PROJECTS_DATA = [
  ...
  { id: 3, name: "Minimalist Office", style: "Minimalist", materials: "Steel, Glass", created: "May 10, 2023" },
  { id: 4, name: "Industrial Loft", style: "Industrial", materials: "Concrete, Metal", created: "Apr 5, 2023" },
];
...
export default function ManageUsersProjects() {
  ...
  const dropdownOptions = activeTab === "users"
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <h1 className="text-2xl font-bold text-gray-900">Manage Users & Projects</h1>
      ...
      <div className="">
        <div className="flex gap-8">
          ...
          <button
            ...
            className={`pb-1 text-sm cursor-pointer font-medium border-b-2 transition-colors ${
              activeTab === "projects" ? "border-blue-600 text-blue-600" : "border-transparent text-gray-600 hover:text-gray-900"
            }`}
          >
            Projects
          </button>
